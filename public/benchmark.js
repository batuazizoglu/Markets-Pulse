...
bmStyle.textContent=`
#benchmark-section{scroll-margin-top:90px}.bm-headline{display:flex;justify-content:space-between;gap:12px;align-items:end;margin-bottom:10px}.bm-headline h2{margin:0;font-size:16px}.bm-headline p{margin:2px 0 0;color:var(--muted);font-size:12px}.bm-tabs{display:flex;gap:6px;overflow:auto;padding:2px 0 10px;scrollbar-width:none}.bm-tabs::-webkit-scrollbar{display:none}.bm-tab{white-space:nowrap;border:1px solid var(--line);background:var(--surface);border-radius:999px;padding:7px 10px;font-size:10px;font-weight:850;color:var(--muted);cursor:pointer}.bm-tab.active{background:var(--navy);border-color:var(--navy);color:#fff}.bm-score-title{display:flex;justify-content:space-between;align-items:center;gap:10px;margin:1px 0 8px}.bm-score-title b{font-size:12px}.bm-score-title span{font-size:9px;color:var(--muted)}.bm-score-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:8px;margin-bottom:12px}.bm-score-card{appearance:none;text-align:left;border:1px solid var(--line);background:var(--surface);border-radius:13px;padding:11px;box-shadow:var(--shadow);cursor:pointer;min-width:0}.bm-score-card:hover{border-color:#cbd5e1}.bm-score-card.active{outline:2px solid var(--navy);outline-offset:1px}.bm-score-card .seg{display:block;font-size:9px;text-transform:uppercase;letter-spacing:.04em;color:var(--muted);font-weight:850;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.bm-score-main{display:flex;align-items:baseline;gap:3px;margin-top:5px}.bm-score-main strong{font-size:25px;line-height:1}.bm-score-main small{font-size:9px;color:var(--muted)}.bm-score-level{display:block;margin-top:5px;font-size:9px;font-weight:900}.bm-score-meta{display:block;margin-top:3px;font-size:8px;color:var(--muted)}.bm-score-trend{display:block;margin-top:5px;font-size:9px;font-weight:850}.bm-score-trend.up{color:var(--good)}.bm-score-trend.down{color:var(--bad)}.bm-score-trend.flat{color:var(--muted)}.bm-score-card.strong .bm-score-main strong,.bm-score-card.strong .bm-score-level{color:var(--good)}.bm-score-card.balanced .bm-score-main strong,.bm-score-card.balanced .bm-score-level{color:var(--warn)}.bm-score-card.weak .bm-score-main strong,.bm-score-card.weak .bm-score-level{color:var(--bad)}.bm-score-card.empty .bm-score-main strong,.bm-score-card.empty .bm-score-level{color:var(--muted)}.bm-trend{background:var(--surface);border:1px solid var(--line);border-radius:14px;box-shadow:var(--shadow);margin-bottom:12px;overflow:hidden}.bm-trend-head{display:flex;justify-content:space-between;gap:12px;align-items:center;padding:12px 14px;border-bottom:1px solid var(--line)}.bm-trend-head b{font-size:12px}.bm-trend-sub{font-size:9px;color:var(--muted);margin-top:2px}.bm-horizons{display:flex;gap:5px}.bm-horizon{border:1px solid var(--line);background:var(--surface);border-radius:999px;padding:5px 8px;font-size:9px;font-weight:850;cursor:pointer}.bm-horizon.active{background:var(--navy);border-color:var(--navy);color:#fff}.bm-trend-body{display:grid;grid-template-columns:minmax(0,1fr) 150px;gap:12px;align-items:center;padding:12px 14px}.bm-chart{min-height:128px;background:var(--surface2);border:1px solid var(--line);border-radius:10px;display:flex;align-items:center;justify-content:center;overflow:hidden}.bm-chart svg{width:100%;height:128px;display:block}.bm-trend-stat{border-left:1px solid var(--line);padding-left:12px}.bm-trend-stat span{display:block;font-size:9px;color:var(--muted);text-transform:uppercase;font-weight:800}.bm-trend-stat strong{display:block;font-size:24px;margin-top:3px}.bm-trend-stat strong.up{color:var(--good)}.bm-trend-stat strong.down{color:var(--bad)}.bm-trend-stat small{display:block;color:var(--muted);font-size:9px;line-height:1.4;margin-top:5px}.bm-kpis{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-bottom:12px}.bm-kpi{background:var(--surface);border:1px solid var(--line);border-radius:14px;box-shadow:var(--shadow);padding:14px}.bm-kpi span{display:block;font-size:10px;text-transform:uppercase;letter-spacing:.06em;color:var(--muted);font-weight:800}.bm-kpi strong{display:block;font-size:23px;margin-top:5px}.bm-kpi.good strong{color:var(--good)}.bm-kpi.bad strong{color:var(--bad)}.bm-kpi.warn strong{color:var(--warn)}.bm-grid{display:grid;grid-template-columns:minmax(0,1.65fr) minmax(300px,.75fr);gap:12px}.bm-panel{background:var(--surface);border:1px solid var(--line);border-radius:14px;box-shadow:var(--shadow);overflow:hidden}.bm-panel-head{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:13px 15px;border-bottom:1px solid var(--line)}.bm-status{font-size:10px;color:var(--muted)}.bm-table-wrap{overflow:auto;max-height:650px}.bm-table{width:100%;border-collapse:collapse;min-width:1120px}.bm-table th,.bm-table td{padding:10px 11px;border-bottom:1px solid var(--line);text-align:left;vertical-align:middle;font-size:11px}.bm-table th{position:sticky;top:0;background:var(--surface2);color:var(--muted);font-size:9px;text-transform:uppercase;letter-spacing:.05em;z-index:2}.bm-pos{display:inline-flex;padding:4px 7px;border-radius:999px;font-size:9px;font-weight:900}.bm-pos.ours{background:var(--goodbg);color:var(--good)}.bm-pos.theirs{background:var(--badbg);color:var(--bad)}.bm-pos.parity{background:var(--warnbg);color:var(--warn)}.bm-gap.good{color:var(--good);font-weight:800}.bm-gap.bad{color:var(--bad);font-weight:800}.bm-source-list{padding:12px 14px}.bm-source{padding:10px 0;border-bottom:1px solid var(--line)}.bm-source:last-child{border-bottom:0}.bm-source-top{display:flex;justify-content:space-between;gap:8px}.bm-source b{font-size:12px}.bm-source small{display:block;color:var(--muted);margin-top:3px}.bm-actions{padding:12px 14px;border-top:1px solid var(--line);background:var(--surface2);font-size:10px;color:var(--muted)}.bm-mobile{display:none;padding:10px}.bm-card{border:1px solid var(--line);border-radius:12px;padding:13px;margin-bottom:9px}.bm-card-top{display:flex;justify-content:space-between;gap:10px}.bm-card h3{margin:0;font-size:13px}.bm-vs{display:grid;grid-template-columns:1fr 24px 1fr;gap:7px;align-items:center;margin-top:10px}.bm-side{background:var(--surface2);border-radius:9px;padding:9px}.bm-side span{display:block;font-size:9px;color:var(--muted);text-transform:uppercase}.bm-side b{display:block;font-size:11px;margin-top:2px}.bm-versus{text-align:center;color:var(--muted);font-size:9px}.bm-rec{margin-top:9px;padding:8px 9px;background:var(--surface2);border-radius:8px;font-size:10px;color:var(--ink)}.bm-refresh{border:1px solid var(--line);background:var(--surface);border-radius:8px;padding:6px 9px;font-size:10px;font-weight:800;cursor:pointer}.bm-badges{display:flex;gap:4px;flex-wrap:wrap;margin-top:5px}.bm-badge{font-size:8px;font-weight:850;padding:3px 5px;border-radius:999px;background:var(--surface2);color:var(--muted)}.bm-seg-summary{display:grid;grid-template-columns:repeat(5,1fr);gap:6px;padding:10px 14px;border-bottom:1px solid var(--line);background:var(--surface2)}.bm-seg-mini{padding:8px;border:1px solid var(--line);border-radius:9px;background:var(--surface)}.bm-seg-mini span{display:block;font-size:8px;color:var(--muted);text-transform:uppercase}.bm-seg-mini b{display:block;font-size:14px;margin-top:3px}.bm-method{padding:10px 14px;background:var(--surface2);border-top:1px solid var(--line);font-size:9px;line-height:1.5;color:var(--muted)}
@media(max-width:1100px){.bm-score-grid{grid-template-columns:repeat(3,1fr)}}
@media(max-width:1000px){.bm-grid{grid-template-columns:1fr}.bm-kpis{grid-template-columns:repeat(2,1fr)}.bm-seg-summary{grid-template-columns:repeat(3,1fr)}}
@media(max-width:720px){.bm-headline{align-items:flex-start}.bm-headline p{display:none}.bm-table-wrap{display:none}.bm-mobile{display:block}.bm-kpis{gap:8px}.bm-kpi{padding:12px}.bm-kpi strong{font-size:19px}.bm-seg-summary{grid-template-columns:repeat(2,1fr)}.bm-score-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.bm-score-card{padding:10px}.bm-score-main strong{font-size:22px}.bm-score-title span{display:none}.bm-trend-body{grid-template-columns:1fr}.bm-trend-stat{border-left:0;border-top:1px solid var(--line);padding-left:0;padding-top:10px}.bm-trend-head{align-items:flex-start;flex-direction:column}.bm-chart{min-height:115px}.bm-chart svg{height:115px}}
`;
...
function setBmTrendDays(days){bmTrendDays=Number(days)||7;renderBenchmark(bmData)}
...
function renderTrendChart(points){
  if(!points.length)return '<div class="empty">Henüz tarihçe kaydı yok.</div>';
  const pts=points.slice(-bmTrendDays);
  const w=600,h=128,p=16;
  const x=i=>pts.length===1?w/2:p+(i*(w-2*p)/(pts.length-1));
  const y=score=>h-p-(Number(score)/100)*(h-2*p);
...
function renderTrendPanel(){
  const key=bmTrendKey(bmSegment),trend=bmTrendFor(bmSegment);
  const delta=trend?.deltas?.[`${bmTrendDays}d`]??null;
...
function renderBenchmarkCard(m){
  const admin=bmIsAdmin();
  return `<article class="bm-card"><div class="bm-card-top"><div><h3>${bmEsc(m.segment)}</h3><div class="bm-badges">${bmBadge(m.acquisition)}${bmBadge(m.channel)}</div>${admin?`<div class="muted">${bmEsc(m.match_status)} • ${bmEsc(m.match_origin==='admin'?'Yönetici kararı':'Otomatik')} • ${bmNum(m.match_score)}/100</div>`:''}</div>${bmPos(m.position)}</div><div class="bm-vs"><div class="bm-side"><span>Telsim</span><b>${bmEsc(m.telsim.name)}</b><small>${admin?bmNum(m.telsim.effective_data_gb,' GB'):bmAllowances(m.telsim)} • ${bmNum(m.telsim.price_try,' TL')}</small>${admin?'':`<br><small>${bmSourceLink(m.telsim)}</small>`}</div><div class="bm-versus">VS</div><div class="bm-side"><span>KKTCELL</span><b>${bmEsc(m.kktcell.name)}</b><small>${admin?bmNum(m.kktcell.effective_data_gb,' GB'):bmAllowances(m.kktcell)} • ${bmNum(m.kktcell.price_try,' TL')}</small><div class="bm-badges">${bmBadge(m.kktcell?.acquisition)}${bmBadge(m.kktcell?.channel)}</div>${admin?'':`<small>${bmSourceLink(m.kktcell)}</small>`}</div></div>${admin?`<div class="bm-rec"><b>Öneri:</b> ${bmEsc(m.recommendation)}</div>`:''}</article>`
}
