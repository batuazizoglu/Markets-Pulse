...
const sendVisuals=(_,res)=>res.json({rows,groups:{home:1,gsm:1,mnp:1},monitoring:{status:'partial',checked_at:at,imported_at:at,schedule:{enabled:true,description:'Her sabah'},coverage:[{brand:'Telsim',status:'partial',country:'CY',checked_at:at,source_url:'https://www.facebook.com/kktctelsim',note:'Test kaydı'}]}});
