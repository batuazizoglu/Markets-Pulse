...
const sendVisuals=(_,res)=>res.json({rows,groups:{home:1,gsm:1,mnp:1},cloud:{vision_configured:false,worker_online:true,worker_heartbeat:at,message:'Bulut taraması etkin. Görsel analiz bağlantısı bekleniyor.',candidates:{pending:12},sources:[{brand:'Telsim',status:'partial',captured:12,note:'Test kaydı'}]},monitoring:{status:'partial',checked_at:at,imported_at:at,schedule:{enabled:true,description:'Bulutta her gün 06:00'},coverage:[{brand:'Telsim',status:'partial',country:'CY',checked_at:at,source_url:'https://www.facebook.com/kktctelsim',note:'Test kaydı'}]}});
